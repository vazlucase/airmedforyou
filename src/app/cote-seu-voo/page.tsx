      ...
      <section className="bg-paper py-24 md:py-32">
        <Container className="grid grid-cols-1 gap-14 lg:grid-cols-[1.15fr_0.85fr] lg:gap-20">
          ...
          <div className="flex flex-col gap-6 lg:sticky lg:top-32 lg:self-start">
            ...
            <Reveal delay={0.15}>
              <div className="rounded-2xl bg-ink-panel p-6 text-white">
                <p className="text-sm leading-relaxed text-white/80">
                  Certificações ANAC, ANVISA e supervisão médica pelo CRM em cada operação.
                </p>
                <p className="mt-3 font-heading text-[0.65rem] font-semibold uppercase tracking-[0.14em] text-teal-300/70">
