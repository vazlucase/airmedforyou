      ...
      <Container className="relative py-16 md:py-20">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[1.3fr_0.9fr_0.9fr_1.1fr]">
          <div className="flex flex-col gap-5">
            <Image src={logo} alt={SITE.name} className="h-7 w-auto brightness-0 invert" />
          ...
          <div>
            <h3 className="mb-4 font-mono text-2xs font-medium uppercase tracking-[0.16em] text-white/40">
              Navegação
            </h3>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <Link href="/cote-seu-voo" className="text-sm text-white/70 transition-colors hover:text-white">
                  Cote seu Voo
                </Link>
              </li>
              <li>
                <Link href="/conhecer-mais" className="text-sm text-white/70 transition-colors hover:text-white">
                  Conhecer Mais
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3.5 text-sm text-white/70">
              ...
              <li>
                <a href={`tel:${CONTACT.phoneDigits}`} className="flex items-start gap-2.5 transition-colors hover:text-white">
